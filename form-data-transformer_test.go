...
func TestHandler(t *testing.T) {
	...
	tests := []struct {
		...
		{"Status200TV", args{rr1, reqTV}},
		{"Status200Storm", args{rr2, reqStorm}},
	}
	for _, tt := range tests {
		...
		if ctype := rr1.Header().Get("Content-Type"); ctype != "application/json" {
